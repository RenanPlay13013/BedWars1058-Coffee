...
//    private static final String version = Bukkit.getServer().getClass().getName().split("\\.")[3];
    private static final String version = "v1_21_R3";
    ...
    @Override
    public void onLoad() {
        getLogger().info("SERVER CLASS = " + Bukkit.getServer().getClass().getName());
        getLogger().info("=== BedWars1058 onLoad ===");
        ...
        Class<?> supp;
        String supportClass =
                "com.andrei1058.bedwars.support.version."
                        + version
                        + "."
                        + version;

        getLogger().info("Trying support class: " + supportClass);

        try {
            supp = Class.forName(supportClass);
            getLogger().info("Support class found: " + supp.getName());
        } catch (Throwable e) {
            getLogger().severe("Failed loading support class:");
            e.printStackTrace();
        ...
        Bukkit.getServicesManager().register(
                com.andrei1058.bedwars.api.BedWars.class,
                api,
                this,
        ...
        try {
            getLogger().info("Creating VersionSupport instance...");

            nms = (VersionSupport) supp
                    .getConstructor(org.bukkit.plugin.Plugin.class, String.class)
                    .newInstance(this, version);

            getLogger().info("VersionSupport loaded successfully: "
                    + nms.getClass().getName());

        } catch (Throwable e) {
            getLogger().severe("Failed creating VersionSupport:");
            e.printStackTrace();
        ...
        generators = new GeneratorsConfig(
                this,
                "generators",
        ...
        getLogger().info("=== BedWars1058 onLoad finished ===");
    }
