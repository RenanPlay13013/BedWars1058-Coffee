package com.andrei1058.bedwars.support.version.v1_21_R3.despawnable;
...
public abstract class DespawnableProvider<T extends LivingEntity> {
    ...
    protected void applyDefaultSettings(org.bukkit.entity.@NotNull LivingEntity bukkitEntity, DespawnableAttributes attr,
        ...
        Objects.requireNonNull(entity.g(GenericAttributes.s)).a(attr.health());
        Objects.requireNonNull(entity.g(GenericAttributes.v)).a(attr.speed());
        Objects.requireNonNull(entity.g(GenericAttributes.c)).a(attr.damage());
    }
}
