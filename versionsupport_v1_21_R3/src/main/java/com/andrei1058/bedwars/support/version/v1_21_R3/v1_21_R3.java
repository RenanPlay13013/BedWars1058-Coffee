...
import com.andrei1058.bedwars.support.version.v1_21_R3.despawnable.DespawnableAttributes;
import com.andrei1058.bedwars.support.version.v1_21_R3.despawnable.DespawnableFactory;
import com.andrei1058.bedwars.support.version.v1_21_R3.despawnable.DespawnableType;
...
public class v1_21_R3 extends VersionSupport {
    ...
    public boolean isArmor(org.bukkit.inventory.ItemStack itemStack) {
        ...
        return i instanceof ItemArmor; //Elytra Removed from || comparation here.
    ...
    public org.bukkit.inventory.ItemStack addCustomData(org.bukkit.inventory.ItemStack i, String data) {
        return setTag(i, PLUGIN_TAG_GENERIC_KEY, data);
    }
    ...
    public org.bukkit.inventory.ItemStack setTag(org.bukkit.inventory.ItemStack itemStack, String key, String value) {
        ...
        meta.getPersistentDataContainer().set(
                new NamespacedKey(getPlugin(), key),
                PersistentDataType.STRING,
                value
        );
    ...
    public boolean isCustomBedWarsItem(org.bukkit.inventory.ItemStack i) {
        return getTag(i, PLUGIN_TAG_GENERIC_KEY) != null;
    }

    @Override
    public String getCustomData(org.bukkit.inventory.ItemStack i) {
        return getTag(i, PLUGIN_TAG_GENERIC_KEY);
    }
    ...
    public String getShopUpgradeIdentifier(org.bukkit.inventory.ItemStack itemStack) {
       String value = getTag(itemStack, PLUGIN_TAG_GENERIC_KEY);
    ...
    public org.bukkit.inventory.ItemStack setShopUpgradeIdentifier(org.bukkit.inventory.ItemStack itemStack, String identifier) {
        return setTag(itemStack, PLUGIN_TAG_GENERIC_KEY, identifier);
    }
    ...
    public org.bukkit.inventory.ItemStack getPlayerHead(Player player, org.bukkit.inventory.ItemStack copyTagFrom) {
        ...
        if (copyTagFrom != null) {
            String customData = getTag(copyTagFrom, VersionSupport.PLUGIN_TAG_GENERIC_KEY);

            String tier = getTag(copyTagFrom, VersionSupport.PLUGIN_TAG_GENERIC_KEY);

            if (customData != null) {
                head = setTag(head, VersionSupport.PLUGIN_TAG_GENERIC_KEY, customData);
            }

            if (tier != null) {
                head = setTag(head, VersionSupport.PLUGIN_TAG_GENERIC_KEY, tier);
            }
        }
